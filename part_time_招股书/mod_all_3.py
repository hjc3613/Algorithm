import os
from modification_3 import modification_3
import json
from tqdm import tqdm
directory = '最新文件抽取结果-fix2'
output_dir = '最新文件抽取结果-fix3'
...
for i,f in tqdm(enumerate(file_path)):
    ...
    output = modification_3(f, f"{output_dir}/{os.path.split(dir)[-1]}/{file_name}")
    if output:

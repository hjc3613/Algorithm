import os
from modification_5 import modification_5
import json
from tqdm import tqdm
directory = '最新文件抽取结果-fix4'
output_dir = '最新文件抽取结果-fix5'
...
for foldername in os.listdir(directory):
    ...
    ok_folder_path = os.path.join(folder_path, "毛利率")
...
for i,f in tqdm(enumerate(file_path)):
    ...
    output = modification_5(f, f"{output_dir}/{os.path.split(dir)[-1]}/{file_name}")
    if output:
        debug[output[0]] = output[1]
print()
with open ('debug_毛利率.json','w') as f:
